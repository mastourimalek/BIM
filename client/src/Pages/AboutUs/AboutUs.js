...
import carous1 from "./bim-building.jpg";
import carous2 from "./bim-2.jpg";
import carous3 from "./bim3.jpg";
    ...
    <div className="All">
      <div>
        <img
          ...
          height="70"
        />
        <h1 id="welcome">WELCOME TO BIM STORE LIBRARY </h1>
      </div>
      ...
      <div>
        ...
        <div className="parag">
          <div className="p1">
          <p>
            Welcome to our online BIM store! We offer a vast selection of BIM
            products. Shop with us for high-quality products
            and exceptional customer service. Explore our collection of BIM documents
            ...
            website allows you to easily browse and purchase our products from the
